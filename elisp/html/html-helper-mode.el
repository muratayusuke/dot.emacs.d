...
(mapcar
 ...
 '(
   ...
   (list    "l"       "<li>"            "html-item"               (& "<li>" (r . "Item: ") "</li>"))
   (list    "t"       "<dt>"            "html-definition-item"    (& "<dt>" (p . "Term: ") "</dt>" > "\n<dd>" > (r . "Definition: ") "</dd>"))
   ...
   (head    "j"       "<script"     "html-javascript"      ("<script type=\"text/javascript\" src=\"" p "\"></script>"))
   ))
